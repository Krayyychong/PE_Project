                ...
                <div class="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
                    ...
                    <div class="col-span-full">
                        ...
                        <div class="relative mt-2.5">
                            ...
                            <asp:TextBox ID="CardNo" runat="server" Width="650px" CssClass="block w-full rounded-md border-0 px-3.5 py-2 pl-24 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"></asp:TextBox>
                        </div>
             ...
             <div class="relative mt-2 rounded-md shadow-sm">
                 <input datepicker id="expireDate" type="text" runat="server" Width="308px"
                    ...
                    <div>
                        <asp:Label ID="label8" runat="server" CssClass="block text-sm font-semibold leading-6 text-gray-900">Expiry Date</asp:Label>
                        <div class="relative mt-2 rounded-md shadow-sm">
                            <asp:TextBox ID="ExpireDate" runat="server" Width="308px" CssClass="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"></asp:TextBox>
                        </div>
                        <asp:RequiredFieldValidator ID="rfvExpireDate" runat="server" ControlToValidate="ExpireDate" ErrorMessage="Expiry date is required." ForeColor="Red" CssClass="validator"></asp:RequiredFieldValidator>
                    </div>
